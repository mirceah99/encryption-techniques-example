import { decrypt, displayMatrixForText, displayMatrixOrderedByKey, displayResult, } from "./utils.js";
import { TEXT_ENCRYPT, TEXT_DECRYPT, KEY_INPUT, ENCRYPT, DECRYPT, T_CYPRESS_INT_MATRIX, T_CYPRESS_INT_MATRIX_KEY, T_CYPRESS_ENCRYPT_MATRIX_KEY, T_CYPRESS_ENCRYPT_MATRIX, RESULT, } from "./htmlElements.js";
ENCRYPT.addEventListener("click", () => {
    ...
    const result = displayMatrixOrderedByKey(TEXT_ENCRYPT.value, T_CYPRESS_ENCRYPT_MATRIX_KEY, KEY_INPUT.value, T_CYPRESS_ENCRYPT_MATRIX);
